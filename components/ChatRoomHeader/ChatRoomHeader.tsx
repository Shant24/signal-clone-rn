...
const ChatRoomHeader: FC<IChatRoomHeaderProps> = ({ children }) => {
  ...
  return (
    <View style={[styles.container, { width: width - 25 }]}>
      ...
      <View style={styles.rightContainer}>
        <Feather style={styles.icon} name="camera" size={24} color={color} />
        <Feather style={styles.icon} name="edit-2" size={24} color={color} />
      </View>
    </View>
  );
};
