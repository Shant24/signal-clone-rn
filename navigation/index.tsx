...
const RootNavigator = () => (
  <Stack.Navigator>
    ...
    <Stack.Group screenOptions={{ presentation: 'card' }}>
      <Stack.Screen name="ChatRoom" component={ChatRoomScreen} options={{ headerShown: true, title: 'Chat Room' }} />
    </Stack.Group>

    <Stack.Screen name="NotFound" component={NotFoundScreen} options={{ headerShown: true, title: 'Oops!' }} />

    <Stack.Group screenOptions={{ presentation: 'modal' }}>
      <Stack.Screen name="Modal" component={ModalScreen} options={{ headerShown: true, animation: 'fade' }} />
    </Stack.Group>
  </Stack.Navigator>
);
